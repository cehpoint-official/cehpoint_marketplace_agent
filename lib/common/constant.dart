...
Color blue700 = const Color(0xFF08215E);
...
List<String> paymentdOptionDetails = [
  ...
  "Total amount you are to receive from Cehpoint Marketplace for dispatched orders. It includes the “Next Payment” amounts shown above.",
